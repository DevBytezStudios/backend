...
class ConfeitariaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            // $paginator = DB::table('produtos')->select('id', 'nome', 'imagem', 'valor', 'valor_desc', 'descricao')->where('id_con', $this->confeitaria->id)->where('id_cat', $categorias[0]->id)->orderBy('id')->cursorPaginate(10);
            $catalogo = [
