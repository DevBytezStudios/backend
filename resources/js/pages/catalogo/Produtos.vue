...
import GridVisualization from '@/components/Dashboard/Produtos/GridVisualization.vue';
...
//     descricao: 'Massa leve com cacau, recheio suave e cobertura cremosa.',
//     valor: 89.9,
//     valorDesc: 79.9,
//     imagem: "https://picsum.photos/seed/bolo1/300/300",
//     categoria: "Bolos",
//     variacoes: [
//       {
//         nome: "Tamanho",
//         options: [
//           { titulo: "Pequeno", valor: 0 },
//           { titulo: "Médio", valor: 20 },
//           { titulo: "Grande", valor: 40 }
//         ]
//       }
//     ]
//   },
...
//     descricao: "Cupcake macio com cobertura artesanal.",
//     valor: 8.0,
//     valorDesc: 7.0,
//     imagem: "https://picsum.photos/seed/cupcake2/300/300",
//     categoria: "Cupcakes",
//     variacoes: [
//       {
//         nome: "Sabor",
//         options: [
//           { titulo: "Chocolate", valor: 0 },
//           { titulo: "Baunilha", valor: 0 },
//           { titulo: "Morango", valor: 0 }
//         ]
//       }
//     ]
//   },
...
//     descricao: "Feito com chocolate belga para um sabor intenso.",
//     valor: 3.5,
//     valorDesc: 2.9,
//     imagem: "https://picsum.photos/seed/brigadeiro3/300/300",
//     categoria: "Doces",
//     variacoes: [
//       {
//         nome: "Tipo",
//         options: [
//           { titulo: "Tradicional", valor: 0 },
//           { titulo: "Meio Amargo", valor: 0 }
//         ]
//       }
//     ]
//   },
...
//     id: 4,
//     nome: "Torta de Limão",
//     descricao: "Base crocante com mousse suave de limão.",
//     valor: 59.9,
//     valorDesc: 49.9,
//     imagem: "https://picsum.photos/seed/torta4/300/300",
//     categoria: "Tortas",
//     variacoes: [
//       {
//         nome: "Tamanho",
//         options: [
//           { titulo: "Pequena", valor: 0 },
//           { titulo: "Grande", valor: 20 }
//         ]
//       }
//     ]
//   },
...
//     valor: 39.9,
//     valorDesc: 34.9,
//     imagem: "https://picsum.photos/seed/cenoura5/300/300",
//     categoria: "Bolos",
//     variacoes: [
//       {
//         nome: "Cobertura",
...
//     valor: 6.5,
//     valorDesc: 5.5,
//     imagem: "https://picsum.photos/seed/pao6/300/300",
//     categoria: "Doces",
//     variacoes: [
//       {
//         nome: "Recheio",
//         options: [
//           { titulo: "Doce de Leite", valor: 0 },
//           { titulo: "Brigadeiro", valor: 1 }
//         ]
//       }
//     ]
//   },
...
//     id: 7,
//     nome: "Brownie",
//     descricao: "Brownie macio por dentro e crocante por fora.",
//     valor: 14.9,
//     valorDesc: 12.9,
//     imagem: "https://picsum.photos/seed/brownie7/300/300",
//     categoria: "Brownies",
//     variacoes: [
//       {
//         nome: "Adicionais",
//         options: [
//           { titulo: "Sem Adicional", valor: 0 },
//           { titulo: "Nutella", valor: 5 },
//           { titulo: "Ninho", valor: 4 }
//         ]
//       }
//     ]
//   },
...
//     descricao: "Bolo totalmente personalizável para festas.",
//     valor: 129.9,
//     valorDesc: 109.9,
//     imagem: "https://picsum.photos/seed/aniver8/300/300",
//     categoria: "Bolos",
//     variacoes: [
//       {
//         nome: "Recheio",
//         options: [
//           { titulo: "Chocolate", valor: 0 },
//           { titulo: "Ninho", valor: 10 },
//           { titulo: "Doce de Leite", valor: 12 }
//         ]
//       }
//     ]
//   },
...
//     id: 9,
//     nome: "Macaron",
//     descricao: "Delicado doce francês com diversas opções de sabor.",
//     valor: 5.0,
//     valorDesc: 4.5,
//     imagem: "https://picsum.photos/seed/macaron9/300/300",
//     categoria: "Doces Finos",
//     variacoes: [
//       {
//         nome: "Sabor",
//         options: [
//           { titulo: "Framboesa", valor: 0 },
//           { titulo: "Pistache", valor: 1 },
//           { titulo: "Baunilha", valor: 0 }
//         ]
//       }
//     ]
...
//   {
//     id: 10,
//     nome: "Cookies Americanos",
//     descricao: "Cookies com gotas de chocolate ao estilo americano.",
//     valor: 6.5,
//     valorDesc: 5.5,
//     imagem: "https://picsum.photos/seed/cookie10/300/300",
//     categoria: "Biscoitos",
//     variacoes: [
//       {
//         nome: "Sabor",
//         options: [
//           { titulo: "Chocolate", valor: 0 },
//           { titulo: "Branco", valor: 0 },
//           { titulo: "Caramelo", valor: 0 }
//         ]
//       }
//     ]
//   }
...
const updateProducts = (produto: Produto) => {
    console.log('a');
};
</script>
    ...
    <AppLayout>
        <header class="menubar">
            ...
            >
                <ToggleGroupItem
                    value="list"
                    class="rounded-md px-3 py-1.5 text-sm data-[state=on]:bg-muted data-[state=on]:font-medium"
                >
                    <svg
                        viewBox="0 0 24 24"
                        fill="none"
        ...
        <div class="flex flex-col gap-6">
            ...
            <ListVisualization
                ...
                @save-product="updateProducts"
            />
            <GridVisualization v-else :produtos="props.produtos" />
            <!-- PAGINAÇÃO -->
            <Pagination
                v-slot="{ page }"
                :items-per-page="10"
